...
\usepackage{outlines} % Hỗ trợ danh sách nhiều cấp trong phụ lục
...
\usepackage{cite} % Trích dẫn dạng số theo chuẩn IEEE
...
% Đủ chiều cao cho tiêu đề chương dài trong header.
\setlength{\headheight}{35pt}

\def \TITLE{LUẬN VĂN THẠC SĨ}
...
\subfile{Chuong/2_Nen_tang_ly_thuyet_va_cong_nghe}

\newpage
\chapter{PHƯƠNG PHÁP ĐỀ XUẤT}
\label{chapter:ProposedApproach}
\subfile{Chuong/3_Phuong_an_de_xuat}

\newpage
\chapter{XÂY DỰNG VÀ PHÁT TRIỂN HỆ THỐNG}
\label{chapter:SystemDevelopment}
\subfile{Chuong/4_Xay_dung_va_phat_trien_he_thong}
