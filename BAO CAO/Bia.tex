...
{\textbf{\huge{ LUẬN VĂN THẠC SĨ}}}\\[1cm]
{\textbf{\Large{Tích hợp nhận dạng biểu cảm khuôn mặt vào hệ thống CRM để phân tích trải nghiệm khách hàng}}\\[1cm]

{\textbf{\large{ĐOÀN ĐỨC CƯƠNG}}}\\
...
\resizebox{\textwidth}{!}{%
\begin{tabular}{ll}
 \multicolumn{1}{c}{\textbf{Giảng viên hướng dẫn:}} & PGS. TS. Phạm Ngọc Hưng \hspace{0.5cm} 
  \\[0.5cm]
